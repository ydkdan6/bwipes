...
$.extend($.easing, {
  ...
  (function (t) {
    var e, i, a, n, o, s, r;
    (cherix.$window = t(window)),
      (cherix.$body = t(document.body)),
      (cherix.status = ""),
      (cherix.isIE = navigator.userAgent.indexOf("Trident") >= 0),
      (cherix.isEdge = navigator.userAgent.indexOf("Edge") >= 0),
      (cherix.isMobile =
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
          navigator.userAgent
        )),
      (cherix.call = function (t, e) {
        setTimeout(t, e);
      }),
      (cherix.parseOptions = function (t) {
        return "string" == typeof t
          ? JSON.parse(t.replace(/'/g, '"').replace(";", ""))
          : {};
      }),
      (cherix.parseTemplate = function (t, e) {
        return t.replace(/\{\{(\w+)\}\}/g, function () {
          return e[arguments[1]];
        });
      }),
      (cherix.byId = function (t) {
        return document.getElementById(t);
      }),
      (cherix.byTag = function (t, e) {
        return e ? e.getElementsByTagName(t) : document.getElementsByTagName(t);
      }),
      (cherix.byClass = function (t, e) {
        return e
          ? e.getElementsByClassName(t)
          : document.getElementsByClassName(t);
      }),
      (cherix.setCookie = function (t, e, i) {
        var a = new Date();
        a.setTime(a.getTime() + 24 * i * 60 * 60 * 1e3),
          (document.cookie =
            t + "=" + e + ";expires=" + a.toUTCString() + ";path=/");
      }),
      (cherix.getCookie = function (t) {
        for (
      ...
      (cherix.requestTimeout = function (t, e) {
        var i =
      ...
      (cherix.requestInterval = function (t, e, i) {
        var a =
          window.requestAnimationFrame ||
          window.webkitRequestAnimationFrame ||
          window.mozRequestAnimationFrame;
      ...
      (cherix.deleteTimeout = function (t) {
        if (t) {
          var e =
      ...
      (cherix.initCartAction = function (e) {
        cherix.$body
      ...
      (cherix.initScrollTopButton = function () {
        var e = cherix.byId("scroll-top");
      ...
      (cherix.stickyToolboxOptions = {
        minWidth: 0,
        maxWidth: 767,
        top: !1,
        scrollMode: !0,
      }),
      (cherix.stickyProductOptions = {
        minWidth: 0,
        maxWidth: 2e4,
        scrollMode: !0,
        top: !1,
      ...
      (cherix.windowResized = function (e) {
        return (
          e == cherix.resizeTimeStamp ||
            (void 0 === window.innerHeight &&
              (window.innerWidth =
                t(window).width() + cherix.getScrollbarWidth()),
            (cherix.resizeChanged = cherix.canvasWidth != window.innerWidth),
            (cherix.canvasWidth = window.innerWidth),
            (cherix.resizeTimeStamp = e)),
          cherix.resizeChanged
        );
      }),
      (cherix.getScrollbarWidth = function () {
        if (void 0 === cherix.scrollbarSize) {
          var t = document.createElement("div");
          (t.style.cssText =
            "width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;"),
            document.body.appendChild(t),
            (cherix.scrollbarSize = t.offsetWidth - t.clientWidth),
            document.body.removeChild(t);
        }
        return cherix.scrollbarSize;
      }),
      (cherix.stickyContent = (function () {
        function e(t, e) {
          return this.init(t, e);
        }
        function i() {
          cherix.$window.trigger("sticky_refresh.cherix", {
            index: 0,
            offsetTop: 0,
          });
        }
        function a(t) {
          (t && !cherix.windowResized(t.timeStamp)) ||
            (cherix.$window.trigger("sticky_refresh_size.cherix"), i());
        }
        return (
          (e.prototype.init = function (e, i) {
            (this.$el = e),
              (this.options = t.extend(
                ...
                cherix.stickyDefaultOptions,
                i,
                cherix.parseOptions(e.attr("data-sticky-options"))
              )),
              cherix.$window
                .on("sticky_refresh.cherix", this.refresh.bind(this))
                .on("sticky_refresh_size.cherix", this.refreshSize.bind(this));
          }),
                    ...
                    (this.scrollPos <= i && a.hasClass("fix-bottom"))
                      ? (a.addClass("fixed"),
                        ...
                        a.hasClass("product-sticky-content") &&
                          cherix.$body.addClass("addtocart-fixed"))
                      : (a
                          .removeClass("fixed")
                          .css("margin-top", "")
                          .css("margin-bottom", ""),
                        ...
                        a.hasClass("product-sticky-content") &&
                          cherix.$body.removeClass("addtocart-fixed")),
                    (this.scrollPos = i))
                  : (a.addClass("fixed"), this.onFixed && this.onFixed()),
                a.is(".fixed.fix-top")
                  ? ((e.offsetTop += a[0].offsetHeight),
                    (cherix.sticky_top_height = e.offsetTop))
          ...
          cherix.$window.on("cherix_complete", function () {
            window.addEventListener("scroll", i, { passive: !0 }),
              cherix.$window.on("resize", a),
              setTimeout(function () {
                a();
              }, 300);
          }),
          function (i, a) {
            cherix.$(i).each(function () {
              var i = t(this);
      ...
      (cherix.parallax = function (e, i) {
        t.fn.themePluginParallax &&
          cherix.$(e).each(function () {
            var e = t(this);
            e.themePluginParallax(
              t.extend(
                !0,
                cherix.parseOptions(e.attr("data-parallax-options")),
                i
              )
            );
          });
      }),
      (cherix.skrollrParallax = function () {
        cherix.isMobile ||
          ("undefined" != typeof skrollr &&
            cherix.$(".skrollable").length &&
            skrollr.init({ forceHeight: !1 }));
      }),
      (cherix.initFloatingParallax = function () {
        t.fn.parallax &&
          cherix.$(".floating-item").each(function (e) {
            var i = t(this);
            i.data("parallax") &&
              (i.parallax("disable"),
              ...
              i.parallax(cherix.parseOptions(i.data("options")));
          });
      }),
      (cherix.isotopeOptions = {
        itemsSelector: ".grid-item",
        layoutMode: "masonry",
        percentPosition: !0,
        masonry: { columnWidth: ".grid-space" },
      }),
      (cherix.isotopes = function (e, i) {
          ...
          cherix.$(e).each(function () {
            var e = t(this),
              n = t.extend(
                ...
                {},
                a.isotopeOptions,
                cherix.parseOptions(e.attr("data-grid-options")),
                i || {}
              );
            cherix.lazyLoad(e),
      ...
      (cherix.initNavFilter = function (e) {
        t.fn.isotope &&
          cherix.$(e).on("click", function (e) {
            var i = t(this),
            ...
            t(n || ".grid")
              ...
              .isotope("on", "arrangeComplete", function () {
                cherix.$window.trigger("appear.check");
              }),
      ...
      (cherix.ratingTooltip = function (t) {
        for (
          var e = cherix.byClass("ratings-full", t || document.body),
            i = e.length,
            a = function () {
              var t =
      ...
      (cherix.setProgressBar = function (e) {
        cherix.$(e).each(function () {
          var e = t(this),
      ...
      (cherix.alert = function (e) {
        cherix.$body.on("click", e + " .btn-close", function (i) {
          i.preventDefault(),
            t(this)
              .closest(e)
              .fadeOut(function () {
      ...
      (cherix.closeTopNotice = function (e) {
        cherix.$body.on("click", e, function (e) {
          e.preventDefault(), t(".top-banner").slideUp();
        });
      }),
      (cherix.accordion = function (e) {
        cherix.$body.on("click", e, function (e) {
          var a = t(this),
      ...
      (cherix.animationOptions = {
        name: "fadeIn",
        duration: "1.2s",
        delay: ".2s",
      }),
      (cherix.appearAnimate = function (e) {
        cherix.$(e).each(function () {
          var e = this;
          cherix.appear(e, function () {
            if (e.classList.contains("appear-animate")) {
              var i = t.extend(
                {},
                cherix.animationOptions,
                cherix.parseOptions(e.getAttribute("data-animation-options"))
              );
              setTimeout(
                function () {
      ...
      (cherix.priceSlider = function (e, i) {
      ...
      (cherix.stickySidebar = function (e) {
        if (t.fn.themeSticky) {
          var i = 0;
          function a() {
            cherix.$(e).trigger("recalc.pin"),
          ...
          !t(".sticky-sidebar > .filter-actions").length &&
            ...
            setTimeout(a, 300),
            cherix.$window.on("click", ".tab .nav-link", function () {
              setTimeout(a);
            });
        }
      }),
      (cherix.zoomImageOptions = {
        responsive: !0,
        borderSize: 0,
        zoomType: "inner",
        onZoomIn: !0,
      ...
      (cherix.zoomImageObjects = []),
      (cherix.zoomImage = function (e) {
        t.fn.zoom &&
          e &&
          ("string" == typeof e ? t(e) : e).find("img").each(function () {
            var e = t(this);
            (cherix.zoomImageOptions.target = e.parent()),
              (cherix.zoomImageOptions.url = e.attr("data-zoom-image")),
              e.zoom(cherix.zoomImageOptions),
              cherix.zoomImageObjects.push(e);
          });
      }),
      (cherix.zoomImageOnResize = function () {
        cherix.zoomImageObjects.forEach(function (e) {
          e.each(function () {
      ...
      (cherix.lazyLoad = function (t, e) {
        ...
        cherix.$(t)
          .find(".lazy-img")
          .each(function () {
            void 0 !== e && e ? i.call(this) : cherix.appear(this, i);
          });
      }),
      (cherix.initPopup = function (e, i) {
        cherix.$body.hasClass("home") &&
          "true" !== cherix.getCookie("hideNewsletterPopup") &&
          setTimeout(function () {
            cherix.popup({
              ...
              callbacks: {
                beforeClose: function () {
                  t("#hide-newsletter-popup")[0].checked &&
                    cherix.setCookie("hideNewsletterPopup", !0, 7);
                },
              },
            });
          }, 7500),
          cherix.$body.on("click", ".btn-iframe", function (e) {
            e.preventDefault(),
              cherix.popup(
                {
                  items: {
      ...
      (cherix.initNotificationAlert = function () {
        cherix.$body.hasClass("has-notification") &&
          setTimeout(function () {
            cherix.$body.addClass("show-notification");
          }, 5e3);
      }),
      (cherix.countTo = function (e) {
        t.fn.countTo &&
          cherix.$(e).each(function () {
            cherix.appear(this, function () {
              var e = t(this);
              setTimeout(function () {
                e.countTo({
                  onComplete: function () {
        ...
        }),
        {
          init: function () {
            ...
            (i.className = "minipopup-area"),
              cherix.byClass("page-wrapper")[0].appendChild(i),
              (e = t(i)),
          ...
          open: function (n, l) {
            var c,
              d = this,
              p = t.extend(!0, {}, cherix.minipopupOption, n);
            (c = t(cherix.parseTemplate(p.template, p))), (d.space = p.space);
            ...
            u.length &&
              u.on("load", function () {
                (i += c[0].offsetHeight + d.space),
                  ...
                  cherix.$body.on("touchstart", function () {
                    d.resume();
                  }),
                  a.push(c),
      ...
      (cherix.headerToggleSearch = function (t) {
        var e = cherix.$(t);
        cherix.$body.on("click", ".hs-toggle .search-toggle", function (t) {
          t.preventDefault();
        }),
          "ontouchstart" in document
            ? (e.find(".search-toggle").on("click", function (t) {
              ...
              cherix.$body.on("click", function (t) {
                e.removeClass("show");
              }),
  ...
  (function (t) {
    var e = function (t) {
        t.preventDefault(), cherix.$body.addClass("mmenu-active");
      },
      i = function (t) {
        t.preventDefault(), cherix.$body.removeClass("mmenu-active");
      },
      a = {
        init: function () {
          this.initMenu(),
        ...
        initMenu: function () {
          t(".menu li").each(function () {
            ...
            cherix.$window.on("resize", function () {
  ...
  (function (t) {
      ...
      a = function (t) {
        ...
        for (e = 0; e < a; ++e)
          if (!i[e].classList.contains("active")) {
            var n,
              o = cherix.byClass("appear-animate", i[e]);
          ...
          .each(function () {
            var i = t(this),
              a = t.extend(
                ...
                {},
                cherix.animationOptions,
                cherix.parseOptions(i.data("animation-options"))
              ),
              n = a.duration,
              o = a.delay,
              s = a.name;
          ...
          a.find(".swiper-slide .slide-animate").each(function () {
            var e = t(this),
              i = t.extend(
                ...
                {},
                cherix.animationOptions,
                cherix.parseOptions(e.data("animation-options"))
              );
          ...
          if (
            ...
            if (
              ...
              for (var n = 0; n < i.timers.length; n++)
                cherix.deleteTimeout(i.timers[n]);
              i.timers = [];
            }
    ...
    (e.defaults = { slidesPerView: 1, speed: 300 }),
        ...
        if (!c.data("slider")) {
          ...
          f.forEach(function (i) {
            ...
            t.extend(
              !0,
              g,
              cherix.parseOptions(c.attr("data-swiper-options")),
              d
            ),
            i.call(this),
      ...
      (cherix.slider = function (i, a = {}, n = !1) {
        cherix.$(i).each(function () {
          var i = t(this);
          n
            ? new e(i, a)
      ...
      (cherix.slider.pgToggle = function () {
    ...
    (e.prototype.init = function (e) {
      ...
      return (
        ...
        a.$sidebar.length &&
          ...
          a.isNavigation &&
            ((i = i.bind(this)), cherix.$window.on("resize", i)),
          cherix.$window.on("resize", function (t) {
            cherix.windowResized(t.timeStamp) &&
              cherix.$body.removeClass(e + "-active");
          }),
          a.$sidebar
          ...
          a.$sidebar
            ...
            .on("click", function (t) {
              cherix.$body.removeClass(e + "-active"), t.preventDefault();
            })),
        !1
      );
    }),
      (e.prototype.toggle = function () {
        ...
        if (
          ...
          e.$sidebar
            ...
            cherix.$body.toggleClass(e.name + "-active").removeClass("closed");
        setTimeout(function () {
          t(window).trigger("appear.check");
        }, 400);
      }),
      (cherix.sidebar = function (t) {
        return new e().init(t);
      });
  })(jQuery),
  (function (t) {
    var e = {
      init: function () {
        var e;
        cherix.call(cherix.ratingTooltip, 500),
          cherix.call(cherix.setProgressBar(".progress-bar"), 500),
          this.initVariation(),
          ...
          cherix.$body.on("click", ".select-menu a", function (t) {
            t.preventDefault();
          }),
          cherix.$body.on("click", ".selected-item i", function (e) {
            t(e.currentTarget)
              .parent()
              .fadeOut(function () {
                var e = t(this),
          ...
          cherix.$body.on("mousedown", function (e) {
            t(".select-menu").removeClass("opened");
          }),
          cherix.$body.on("click", ".filter-items a", function (e) {
          ...
          cherix.$body.on(
            ...
            function (e) {
              ...
              i.hasClass("disabled")
                ? alert(
                    "Kindly visit the our shop page to buy the product!"
                  )
                : (i.toggleClass("added").addClass("load-more-overlay loading"),
                  setTimeout(function () {
                    i.removeClass("load-more-overlay loading"),
                      cherix.Minipopup.open({
          ...
          (e = t(".product-popup")).length &&
            cherix.$body.on("click", ".btn-quickview", function (i) {
              i.preventDefault(),
                cherix.popup(
                  {
          ...
          (function () {
            ...
            a.length ||
                ...
                .on("click", ".product .btn-compare", function (o) {
                  ...
                  i.length >= 4 && i.shift(),
                    ...
                    t(".compare-popup li").each(function (t) {
                      i[t] &&
                        (this.innerHTML =
                          '<a href="product-detail.html"><figure><img src="' +
                          i[t] +
              ...
              cherix.$body.on("click", ".compare-popup-overlay", function () {
                a.removeClass("show");
              });
          })(),
          cherix.priceSlider(".filter-price-slider");
      },
                ...
                a.data("load-state", "loading"),
                  ...
                  setTimeout(function () {
                    a.next().removeClass("loading"),
                      ...
                      cherix.countDown(i.find(".product-countdown"));
                  }, 500);
                var n = parseInt(
    ...
    (e.min = 1),
      ...
      (e.prototype.startIncrease = function (t) {
        ...
        (e.value = e.$value.val()),
          ...
          (e.increaseTimer = cherix.requestTimeout(function () {
            (e.speed = 1),
              (e.increaseTimer = cherix.requestInterval(function () {
                e.$value.val(
                  (e.value = Math.min(
      ...
      (e.prototype.startDecrease = function (t) {
        ...
        (e.value = e.$value.val()),
          ...
          (e.decreaseTimer = cherix.requestTimeout(function () {
            (e.speed = 1),
              (e.decreaseTimer = cherix.requestInterval(function () {
                e.$value.val(
                  (e.value = Math.max(
                    e.value - Math.floor((e.speed *= 1.05)),
                    e.min
      ...
      (e.prototype.stop = function (t) {
        cherix.deleteTimeout(this.increaseTimer),
          cherix.deleteTimeout(this.decreaseTimer);
      }),
      (cherix.initQtyInput = function (i) {
        cherix.$(i).each(function () {
          var i = t(this);
    ...
    (e.defaults = {
      ...
      (e.prototype.init = function (i, a) {
        ...
        n.isOpen
          ...
          cherix.$body.on("mousedown", ".mfp-wrap", o),
          "ontouchstart" in document &&
            document.addEventListener("touchstart", o, { passive: !0 });
      }),
      (cherix.popup = function (t, i) {
        return new e(t, i);
      });
  })(jQuery),
  (function (t) {
    ...
    (e.prototype.init = function (e) {
      ...
      (o.$wrapper = e),
        ...
        (o._isPgVertical = !1),
        o.isQuickView && ((i = i.bind(this)), cherix.ratingTooltip()),
        (function (t) {
        ...
        "complete" === cherix.status &&
          (cherix.slider(s, {
            thumbs: { swiper: o.$thumbsWrap.data("slider") },
          }),
          cherix.initQtyInput(e.find(".quantity"))),
        s.length &&
          window.addEventListener(
            "resize",
            function () {
              cherix.requestTimeout(function () {
                null != s.data("slider") &&
        ...
        o.$wrapper
          ...
          .on("initialized.slider", function (e) {
            t(e.target).find(".product-image").zoom(cherix.zoomImageOptions);
          }),
      ...
      (e.prototype.variationMatch = function () {
        ...
        t.$priceWrap
          .find("span")
          .text("#" + (Math.round(50 * Math.random()) + 500) + ".00"),
      ...
      (e.prototype.clickStickyThumbnail = function (e) {
        ...
        o.length && ((o = o.offset().top + 10), cherix.scrollTo(o, 500)),
          setTimeout(function () {
      ...
      (cherix.productSingle = function (i) {
        return (
          cherix.$(i).each(function () {
            var i = t(this);
  ...
  (function (t) {
    ...
    cherix.initProductSinglePage = function () {
      t(".product-gallery").each(function () {
        var e = t(this),
          i = e.find(".product-image");
        i.length &&
          0 == e.find(".swiper-container").length &&
          i.zoom(cherix.zoomImageOptions);
      }),
        (function (e) {
          var i = t(e),
  ...
  (function (t) {
    cherix.initCodePopup = function () {
      t(".box-btn.showcode span").each(function () {
        ...
        cherix.$body.on("click", ".box-btn.showcode", function () {
          var e = t(this);
          e.hasClass("enabled")
        ...
        cherix.$body.on("click", ".show-code", function (e) {
          e.stopPropagation();
          var i = t(this).parent();
          if (i.hasClass("show-code-added")) {
            ...
            i[0].removeChild(a),
              ...
              cherix.$body.on("click", ".code-copy a", function (e) {
                e.preventDefault(),
  ...
  (function (t) {
    ...
    (e.defaultOptions = {
      ...
      (e.prototype.init = function (a, n) {
        ...
        (o.element = a),
          (o.settings = t.extend(
            ...
            !0,
            e.defaultOptions,
            cherix.parseOptions(a.attr("data-calendar-options")),
            n
          )),
          (o.today = new Date()),
          (i = i.bind(this));
      ...
      (cherix.slideContent = function (e) {
        var i = t(e),
          a = i.next();
      ...
      (cherix.initLoginVendor = function (e) {
        var i = t(e),
  ...
  jQuery,
  (cherix.initLayout = function () {
    cherix.isotopes(".grid:not(.grid-float)"),
      cherix.stickySidebar(".sticky-sidebar");
  }),
  (cherix.init = function () {
    cherix.appearAnimate(".appear-animate"),
      cherix.setTab(".nav-tabs"),
      cherix.stickyContent(".sticky-header", { scrollMode: !1 }),
      cherix.stickyContent(".sticky-footer", {
        minWidth: 0,
        maxWidth: 767,
        top: 150,
        hide: !0,
      ...
      cherix.stickyContent(".sticky-toolbox", cherix.stickyToolboxOptions),
      cherix.stickyContent(
        ".product-sticky-content",
        cherix.stickyProductOptions
      ),
      cherix.parallax(".parallax"),
      cherix.skrollrParallax(),
      cherix.initFloatingParallax(),
      cherix.menu.init(),
      cherix.initScrollTopButton(),
      cherix.shop.init(),
      cherix.alert(".alert"),
      cherix.closeTopNotice(".banner-close"),
      cherix.accordion(".card-header > a"),
      cherix.sidebar("sidebar"),
      cherix.sidebar("right-sidebar"),
      cherix.productSingle(".product-single"),
      cherix.initProductSinglePage(),
      cherix.initQtyInput(".quantity"),
      cherix.initNavFilter(".nav-filters .nav-filter"),
      cherix.calendar(".calendar-container"),
      cherix.countDown(".product-countdown, .countdown"),
      cherix.initPopup(),
      cherix.initNotificationAlert(),
      cherix.countTo(".count-to"),
      cherix.initCartAction(".cart-offcanvas .cart-toggle"),
      cherix.Minipopup.init(),
      cherix.headerToggleSearch(".hs-toggle"),
      cherix.initVendor(".store"),
      cherix.slideContent(".login-toggle"),
      cherix.slideContent(".coupon-toggle"),
      cherix.slideContent(".checkbox-toggle"),
      cherix.initLoginVendor(".user-checkbox"),
      cherix.initCodePopup(),
      cherix.slider(".swiper-container"),
      cherix.call(cherix.slider.pgToggle),
      cherix.$window.on("resize", function () {
        cherix.call(cherix.slider.pgToggle);
      });
  }),
  ...
  (window.onload = function () {
    (cherix.canvasWidth = window.innerWidth),
      (cherix.resizeTimeStamp = 0),
      (cherix.resizeChanged = !1),
      (cherix.status = "loaded"),
      document.body.classList.add("loaded"),
      cherix.call(cherix.initLayout),
      cherix.call(cherix.init),
      (cherix.status = "complete"),
      cherix.$window.trigger("cherix_complete");
  });
